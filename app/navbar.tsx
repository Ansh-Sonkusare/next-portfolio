...
const Navbar: FunctionComponent<NavbarProps> = ({ className }) => {
  return (
    <div className={className}>
      <nav className="mx-auto flex   max-w-[1360px] items-center justify-between p-4 md:mt-5 ">
        ...
        <ul className="hidden flex-row p-4  font-nohemi text-2xl font-normal md:flex md:space-x-4  md:p-0  ">
          <li>
